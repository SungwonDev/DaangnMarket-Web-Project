...
<form action="write_ok.jsp" method = "post" id="f_form" name="nf_form" enctype = "multipart/form-data" target="iframe1">
    <div id = "sell_object" style="margin: 0 auto; border: 3px solid #ff8a3d; border-radius: 30px">
        ...
        <div class="object_b">
            ...
            <div class="content">
                <textarea name="content" cols="54" rows="18" placeholder="신고할 내용을 적어주세요." style="width:450px; height:335px"></textarea>
            </div>
            <div class="photo">
            <!-- 업로드 -->
