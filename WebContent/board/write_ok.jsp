...
<%@ page import="com.main.board.BoardService" %>
...
<%
	...
	BoardService fs = new BoardService();
	String imgName="";
		...
		if(isMultipart){
			...
			while(iter.hasNext()){
				...
				if(item.isFormField()){	//텍스트 입력인 경우
					...
					if(name.equals("content")){content=value;	/* product.setContent(value); */}
			...
			if(fs.fileUpload(email, username, title, content, hit, file1, file2, file3, file4, file5, dir)){
