...
<body>
	<div>
		...
		<header id="fixed-bar" class="fixed-bar-box-shadow">
			<div id="fixed-bar-wrap">
				<h1 id="fixed-bar-logo-title">
					<a href="../main/MainPage.jsp"> <span class="sr-only">캐럿상점</span>
						<img class="fixed-logo" alt="캐럿상점" src="images/캐럿.PNG">
					</a>
				</h1>

				<form name="search" id="form-search" method="post"
					action="index.jsp">
					<section id="fixed-bar-search">
						<div class="search-input-wrap">
							<span class="sr-only">검색</span> <input type="text" name="keyWord"
				...
				<section id="fixed-bar-download">
					...
					<a target="_blank" class="fixed-download-button"
						id="header-download-button-ios" href="../main/regist.jsp">

						<div class="fixed-download-text">회원 가입</div>
					</a> <a target="_blank" class="fixed-download-button" id=""
						href="../main/login.jsp">
		...
		<header id="fixed-bar" class="fixed-bar-box-shadow">
			<div id="fixed-bar-wrap">
				<h1 id="fixed-bar-logo-title">
					<a href="../main/MainPageLogined.jsp"> <span class="sr-only">캐럿상점</span>
						<img class="fixed-logo" alt="캐럿상점" src="images/캐럿.PNG">
					</a>
				</h1>
				...
				<section id="fixedBarLoginRegist">
					...
					<p>
						<input type="button" value="로그아웃"
							...
							style="margin-right: 8px; width: 140px; border-radius: 5px; border: solid 1px #e9ecef; box-sizing: border-box; text-decoration: none; display: inline-block; vertical-align: middle; text-align: center; padding: 0.9rem 0; background-color: #none">

						<input type="button" value="나의 당근"
							onclick="location.href='../main/myPage.jsp'"
							style="margin-right: 8px; width: 140px; border-radius: 5px; border: solid 1px #e9ecef; box-sizing: border-box; text-decoration: none; display: inline-block; vertical-align: middle; text-align: center; padding: 0.9rem 0;">
					</p>
				</section>
			</div>
			...
			<section id="div_write">
				<div id="write">
					<input type="button" value="글쓰기"
						onclick="self.location='Sobject.jsp'">
				</div>
			</section>
			...
			<section class="cards-wrap">
				...
				<c:forEach var="item" items="${fileList}" varStatus="status">
					...
					<article class="card-top ">
						...
						<!-- 상세페이지 -->
						<a class="card-link " data-event-label="142863274"
							href="receive.jsp?pageindex=${item.idx}">
							<div class="card-photo ">
								<img alt="${item.filename1} "
									src="/Corrot/upload/${item.filename1}?q=82&amp;s=300x300&amp;t=crop">
							</div>
							<div class="card-desc">
								<h2 class="card-title">
									<p>${item.name}</p>
								...
								<div class="card-price ">
									<p>${item.price}&nbsp<span style="font-size: 14px;">원</span>
									</p>
								</div>
								...
								<div class="card-counts">
									<span>관심 6</span> ∙ <span>채팅 31</span>
								</div>
							</div>
						</a>
				...
				<div class="footer-container">
					<div class="footer-top">
						...
						<ul class="footer-list">
							...
							<li class="footer-list-item"><a class="link-highlight"
								href="/wv/faqs">자주 묻는 질문</a></li>
						</ul>
						<ul class="footer-list">
							<li class="footer-list-item"><a target="_blank"
								href="http://team.daangn.com">회사 소개</a></li>
							<li class="footer-list-item"><a target="_blank"
								class="link-highlight" href="https://ad.daangn.com/">광고주센터</a></li>
							<li class="footer-list-item"><a target="_blank"
								class="ga-click" data-event-category="town_link_from"
								data-event-action="hot_articles" data-event-label="footer_town"
					...
					<div class="footer-bottom">
						<div id="copyright">
							<ul class="copyright-list">
								<li class="copyright-list-item">고객문의 <a
									href="mailto:cs@daangnservice.com">cs@daangnservice.com</a></li>
								<li class="copyright-list-item">제휴문의 <a
									href="mailto:contact@daangn.com">contact@daangn.com</a></li>
							</ul>
							<ul class="copyright-list">
								<li class="copyright-list-item">사업자 등록번호 : 375-87-00088</li>
								<li class="copyright-list-item"><address>서울특별시
										구로구 디지털로 30길 28 609호</address></li>
							</ul>
							<div class="copyright-text">©Danggeun Market Inc.</div>
						</div>
						<div id="social">
							<ul class="social-list">
								<li class="social-list-item"><a target="_blank"
									class="footer-social-link"
									href="https://www.facebook.com/daangn"> <img alt="facebook"
								...
								<li class="social-list-item"><a target="_blank"
									class="footer-social-link" href="https://blog.naver.com/daangn">
										<img alt="blog"
